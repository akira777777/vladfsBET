...
async function main() {
  ...
  const gamesList = [
    ...
    },
    {
      ...
      minBet: "1.00",
      maxBet: "1000.00",
      description: "Sandbox slots test engine.",
      tags: ["sandbox", "slots"],
    },
    {
      slug: "sandbox-roulette",
      title: "Sandbox Roulette",
      ...
      minBet: "1.00",
      maxBet: "1000.00",
      description: "Sandbox roulette test game.",
      tags: ["sandbox", "roulette"],
    },
    {
      slug: "sandbox-blackjack",
      title: "Sandbox Blackjack",
      ...
      minBet: "1.00",
      maxBet: "1000.00",
      description: "Sandbox blackjack test game.",
      tags: ["sandbox", "blackjack"],
    },
    // Roulette
    {
